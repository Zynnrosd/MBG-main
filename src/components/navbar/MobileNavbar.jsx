...
export default function MobileNavbar({ currentPage, onNavigate }) {
  const navItems = [
    ...
    { id: 'login', label: 'Login', icon: LogIn } // Item baru ditambahkan
  ];
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              /* Perubahan: min-w-[70px] diubah menjadi min-w-[60px] 
                 agar muat 5 item dengan proporsional di layar kecil 
              */
