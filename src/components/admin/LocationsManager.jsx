    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
        <div>
          ...
          <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mt-1">
            Kelola titik dapur pusat MBG per kecamatan
          </p>
        </div>

        <button
          onClick={() => setIsFormOpen(true)}
          className="bg-blue-600 text-white px-5 py-3 rounded-xl flex gap-2 font-bold hover:bg-blue-700 transition"
        >
          <Plus size={20} />
          Tambah Dapur
        </button>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {locations.map((loc) => (
          <div
            key={loc.id}
            className="bg-white border border-slate-200 p-6 rounded-2xl hover:shadow-md transition group relative"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-3 bg-slate-50 p-4 rounded-2xl">
                ...
                <select
                  ...
                  disabled={!selectedProv || isLoadingApi}
                  className="w-full p-3 border rounded-xl bg-white text-sm disabled:opacity-50"
                  defaultValue=""
                >
                  <option value="" disabled>
                    Pilih Kab/Kota
                ...
                <select
                  ...
                  disabled={!selectedCity || isLoadingApi}
                  className="w-full p-3 border rounded-xl bg-white text-sm disabled:opacity-50"
                  defaultValue=""
                >
                  <option value="" disabled>
